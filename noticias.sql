...
INSERT INTO `categ` (`id_categoria`, `nome_categoria`, `status`) VALUES
(1, 'Esportes', 'Ativo'),
(3, 'Moda', 'Ativo'),
(6, 'Tecnologia', 'Ativo');
...
INSERT INTO `usuario` (`id_usuario`, `nome`, `login`, `senha`, `cargo`, `status`) VALUES
(1, '', '', '', '', 'Ativo'),
(2, 'Gustavo', 'Admin', '123', 'Administrador', 'Ativo'),
(3, '', '', '', '', 'Ativo'),
(4, 'Luiz Eduardo', 'Reckless Flow', 'penis', 'Jornalista', 'Ativo');
